                        ...
                        <td>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        ?>" type="number" class="form-control" placeholder="Id del empleado" name="id"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        ?>" type="text" class="form-control" placeholder="Correo electronico" name="email"
                                                                autocomplete="off">
                                    </div> 
                                </td>
                            </tr>
                        ...
                        <label>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <td>
                                    <div class="form-group">
                                        <textarea class="form-control rounded-0" name="descripcion" id="descripcion" rows="3" placeholder="Descripción de la experiencia del empleado"><?php
                                            $descripcion="";
